...
// • Storage
 class  SmartPhone{
       ...
       int Storage;
        ...
        //methods
        void phonecall(){
            cout << "phone started calling" << endl<<endl;
        } 
        void Send_messages(){
        ...
        // void setsetAddition(SmartPhone data[], int count);
        // void getdata(SmartPhone data[],int count);
        // int setPhoneCall(void);
        // int setSend_messages(void);
        // int setwifi(void);
        // int Browsing(void);
